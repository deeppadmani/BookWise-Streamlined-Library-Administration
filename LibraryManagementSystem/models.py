...
class Book(models.Model):
    ...
    class Meta:
        db_table = 'librarymanagementsystem_book'
...
class Authors(models.Model):
    ...
    class Meta:
        db_table = 'librarymanagementsystem_authors'
...
class BookAuthors(models.Model):
    ...
    class Meta:
        db_table = 'librarymanagementsystem_bookauthors'
...
class Borrower(models.Model):
    ...
    class Meta:
        db_table = 'librarymanagementsystem_borrower'
...
class BookLoans(models.Model):
    ...
    class Meta:
        db_table = 'librarymanagementsystem_bookloans'
...
class Fines(models.Model):
    ...
    class Meta:
        db_table = 'librarymanagementsystem_fines'